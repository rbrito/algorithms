...
\algsetup{linenosize=\small,
          linenodelimiter=.}
\begin{algorithmic}[   \STATE $i \leftarrow 10$
   \RETURN $i$ 
\end{algorithmic}
\end{verbatim}
...
content, then you should use, in your own document, the standard \LaTeX{}
command \keyword{renewcommand}, with an usage like this:
\begin{verbatim}
...
environments, the heading used for the list of algorithms may be changed by
redefining the command \verb+listalgorithmname+.  The default definition
for this command is
\begin{verbatim}
...
this float HERE'', which is something desired by many.
...
$N$ being odd. The numbers you see on this document were generated
